  ...
  render () {
    ...
    return(
      <div className="rp-card" data-testid="rp-card">
        ...
        <h1 onClick={this.changePage.bind(this)} className="rp-card-name" data-testid="rp-card-name">{this.state.name} {this.state.style_name}</h1>
        <h2 className='rp-card-price'data-testid="rp-card-price"><Price original_price={this.state.original_price} sale_price={this.state.sale_price}/></h2>
